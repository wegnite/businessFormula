...
const version = "2.0.0-20241212-153011-af71c96";
...
function defineEnv(opts = {}) {
  ...
  if (opts.resolve) {
    ...
    const _resolve = (id) => resolvePathSync(id, resolveOpts);
...
export { NodeBuiltinModules, cloudflarePreset$1 as cloudflare, defineEnv, env, mapArrToVal, node, nodeCompatPreset as nodeless };
